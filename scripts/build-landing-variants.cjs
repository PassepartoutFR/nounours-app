...
const NAV = `  <nav>
    <div class="wrap">
      ...
      <a class="btn gh" href="https://github.com/PassepartoutFR/nounours-app" target="_blank" rel="noopener" title="Code source" data-uwg-outbound="github">
...
const SECTIONS = `${TICKER}
  ...
  <section id="data"><div class="wrap">
    ...
    <div class="dash">
      ...
      <div class="dash-outreach" id="dashOutreach">
        <div class="spark-lbl" data-i18n="data_outreach_label"></div>
        <p class="outreach-hint" data-i18n="data_outreach_hint"></p>
        <div class="outreach-grid">
          <div class="stat"><div class="stat-emo">⭐</div><div class="stat-num" id="statGithubStars" data-val="0">0</div><div class="stat-lbl" data-i18n="data_stat_stars"></div></div>
          <div class="stat"><div class="stat-emo">🐙</div><div class="stat-num" id="statGithubClicks" data-val="0">0</div><div class="stat-lbl" data-i18n="data_stat_gh_clicks"></div></div>
          <div class="stat"><div class="stat-emo">📦</div><div class="stat-num" id="statReleasesClicks" data-val="0">0</div><div class="stat-lbl" data-i18n="data_stat_rel_clicks"></div></div>
        </div>
        <div class="variant-bars" id="variantBars" hidden>
          <div class="spark-lbl" data-i18n="data_variants_label"></div>
          <div id="variantBarsList"></div>
        </div>
      </div>
      <div class="dash-foot">
  ...
  <section id="install"><div class="wrap install">
    ...
    <div style="margin-top:26px;"><a class="btn" href="https://github.com/PassepartoutFR/nounours-app/releases/latest" target="_blank" rel="noopener" data-uwg-outbound="releases" data-i18n="inst_cta"></a></div>
  </div></section>`;
...
const FOOTER = `  <footer><div class="wrap row">
    ...
    <a href="https://github.com/PassepartoutFR/nounours-app" target="_blank" rel="noopener" data-uwg-outbound="github">★ GitHub</a>
