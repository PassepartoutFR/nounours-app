...
**🇬🇧 English version → [FAQ.en.md](FAQ.en.md)** · **🏠 Hub bilingue → [FAQ.md](FAQ.md)**
...
## Comment supprimer mon entrée du classement ?

**En autonomie, sans e-mail.** Depuis le popup : « Effacer du serveur » (direct) ou
« Code de suppression » (`DEL1`, valable 15 minutes) à coller sur
[nounours.app/privacy.html](https://nounours.app/privacy.html). Le code prouve que
tu possèdes le compte sans exposer ta clé secrète.
